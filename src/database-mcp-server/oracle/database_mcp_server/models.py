...
class ApplicationVipSummary(OCIBaseModel):
    ...
    cloud_vm_cluster_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the cloud_vm_cluster_id of this ApplicationVipSummary. The `OCID`__ of the cloud VM cluster associated with the application virtual IP (VIP) address. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    compartment_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this ApplicationVipSummary. The `OCID`__ of the application virtual IP (VIP) address. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    ip_address: Optional[str] = Field(
        None, description="The application virtual IP (VIP) address."
    )
    ...
    subnet_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the subnet associated with the application virtual IP (VIP) address. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    time_assigned: Optional[datetime] = Field(
        None,
...
class AutonomousContainerDatabaseDataguardAssociation(OCIBaseModel):
    ...
    autonomous_container_database_id: Optional[str] = Field(
        None,
    ...
    fast_start_fail_over_lag_limit_in_seconds: Optional[int] = Field(
        None,
    ...
    is_automatic_failover_enabled: Optional[bool] = Field(
        None,
    ...
    peer_autonomous_container_database_dataguard_association_id: Optional[str] = Field(
        None,
        description="The OCID of the peer Autonomous Container Database-Autonomous Data Guard association.",
    )
    peer_autonomous_container_database_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the peer Autonomous Container Database. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    peer_lifecycle_state: Optional[str] = Field(
        None,
    ...
    protection_mode: Optional[str] = Field(
        None,
        description="The protection mode of this Autonomous Data Guard association. For more information, see `Oracle Data Guard Protection Modes`__ in the Oracle Data Guard documentation. __ http://docs.oracle.com/database/122/SBYDB/oracle-data-guard-protection-modes.htm#SBYDB02000 Allowed values for this property are: \"MAXIMUM_AVAILABILITY\", \"MAXIMUM_PERFORMANCE\", 'UNKNOWN_ENUM_VALUE'. Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.",
    )
    ...
    time_last_role_changed: Optional[datetime] = Field(
        None, description="The date and time when the last role change action happened."
    )
    time_last_synced: Optional[datetime] = Field(
        None,
        description="The date and time of the last update to the apply lag, apply rate, and transport lag values.",
    )
    transport_lag: Optional[str] = Field(
        None,
...
class AutonomousContainerDatabaseVersionSummary(OCIBaseModel):
    ...
    supported_apps: Optional[list[dict]] = Field(
        None,
...
class AutonomousContainerDatabaseSummary(OCIBaseModel):
    ...
    associated_backup_configuration_details: Optional[list[dict]] = Field(
        None,
    ...
    autonomous_exadata_infrastructure_id: Optional[str] = Field(
        None,
    ...
    autonomous_vm_cluster_id: Optional[str] = Field(
        None, description="The OCID of the Autonomous VM Cluster."
    )
    ...
    backup_config: Optional[dict] = Field(None, description="")
    backup_destination_properties_list: Optional[list[str]] = Field(
        None,
    ...
    cloud_autonomous_vm_cluster_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the cloud Autonomous Exadata VM Cluster. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    compartment_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the compartment_id of this AutonomousContainerDatabaseSummary. The OCID of the compartment.",
    )
    compute_model: Optional[str] = Field(
        None,
    ...
    db_split_threshold: Optional[int] = Field(
        None,
    ...
    distribution_affinity: Optional[str] = Field(
        None,
    ...
    dst_file_version: Optional[str] = Field(
        None,
    ...
    is_dst_file_update_enabled: Optional[bool] = Field(
        None,
    ...
    key_history_entry: Optional[list[dict]] = Field(
        None, description="Key History Entry."
    )
    key_store_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the key store of Oracle Vault. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    key_store_wallet_name: Optional[str] = Field(
        None, description="The wallet name for Oracle Key Vault."
    )
    ...
    last_maintenance_run_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the last maintenance run. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    lifecycle_details: Optional[str] = Field(
        None, description="Additional information about the current lifecycle state."
    )
    lifecycle_state: Optional[str] = Field(
        None,
    ...
    next_maintenance_run_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the next maintenance run. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    patch_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the last patch applied on the system. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    patch_model: Optional[str] = Field(
        None,
    ...
    provisionable_cpus: Optional[float] = Field(
        None,
    ...
    recovery_appliance_details: Optional[dict] = Field(None, description="")
    ...
    service_level_agreement_type: Optional[str] = Field(
        None,
    ...
    standby_maintenance_buffer_in_days: Optional[int] = Field(
        None,
    ...
    time_of_last_backup: Optional[datetime] = Field(
        None,
    ...
    time_snapshot_standby_revert: Optional[datetime] = Field(
        None,
    ...
    total_cpus: Optional[int] = Field(
        None, description="The number of CPUs allocated to the Autonomous VM cluster."
    )
    vault_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the Oracle Cloud Infrastructure `vault`__. This parameter and `secretId` are required for Customer Managed Keys. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm __ https://docs.cloud.oracle.com/Content/KeyManagement/Concepts/keyoverview.htm#concepts",
    )
    version_preference: Optional[str] = Field(
        None,
    ...
    vm_failover_reservation: Optional[int] = Field(
        None,
...
class AutonomousDatabaseBackupSummary(OCIBaseModel):
    ...
    autonomous_database_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the autonomous_database_id of this AutonomousDatabaseBackupSummary. The `OCID`__ of the Autonomous Database. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    backup_destination_details: Optional[dict] = Field(None, description="")
    compartment_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the compartment_id of this AutonomousDatabaseBackupSummary. The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    ...
    db_version: Optional[str] = Field(
        None, description="A valid Oracle Database version for Autonomous Database."
    )
    display_name: Optional[str] = Field(
        None,
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this AutonomousDatabaseBackupSummary. The `OCID`__ of the Autonomous Database backup. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    ...
    is_restorable: Optional[bool] = Field(
        None,
    ...
    retention_period_in_days: Optional[int] = Field(
        None, description="Retention period, in days, for long-term backups"
    )
    size_in_tbs: Optional[float] = Field(
        None, description="The backup size in terrabytes (TB)."
    )
    time_available_till: Optional[datetime] = Field(
        None, description="Timestamp until when the backup will be available"
    )
    time_ended: Optional[datetime] = Field(
        None, description="The date and time the backup completed."
    )
    time_started: Optional[datetime] = Field(
        None, description="The date and time the backup started."
    )
...
class AutonomousDatabaseCharacterSets(OCIBaseModel):
    ...
    name: Optional[str] = Field(None, description="A valid Oracle character set.")
...
class AutonomousDatabaseSummary(OCIBaseModel):
    ...
    apex_details: Optional[dict] = Field(
        None, description="Information about Oracle APEX Application Development."
    )
    are_primary_whitelisted_ips_used: Optional[bool] = Field(
        None,
    ...
    auto_refresh_frequency_in_seconds: Optional[int] = Field(
        None,
    ...
    auto_refresh_point_lag_in_seconds: Optional[int] = Field(
        None,
    ...
    autonomous_container_database_id: Optional[str] = Field(
        None,
        description="The Autonomous Container Database `OCID`__. Used only by Autonomous Database on Dedicated Exadata Infrastructure. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    autonomous_maintenance_schedule_type: Optional[str] = Field(
        None,
    ...
    available_upgrade_versions: Optional[str] = Field(
        None,
    ...
    clone_table_space_list: Optional[int] = Field(
        None,
    ...
    cluster_placement_group_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the cluster placement group of the Autonomous Serverless Database. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    compartment_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the compartment_id of this AutonomousDatabaseSummary. The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    ...
    connection_strings: Optional[str] = Field(
        None,
    ...
    connection_urls: Optional[dict] = Field(None, description="")
    ...
    customer_contacts: Optional[list[str]] = Field(
        None, description="Customer Contacts."
    )
    data_safe_status: Optional[str] = Field(
        None,
    ...
    data_storage_size_in_gbs: Optional[int] = Field(
        None,
    ...
    data_storage_size_in_tbs: Optional[int] = Field(
        None,
    ...
    database_edition: Optional[str] = Field(
        None,
    ...
    database_management_status: Optional[str] = Field(
        None,
    ...
    dataguard_region_type: Optional[str] = Field(
        None,
    ...
    db_tools_details: Optional[list[dict]] = Field(
        None,
    ...
    db_workload: Optional[str] = Field(
        None,
    ...
    disaster_recovery_region_type: Optional[str] = Field(
        None,
    ...
    encryption_key: Optional[dict] = Field(None, description="")
    encryption_key_history_entry: Optional[list[dict]] = Field(
        None, description="Key History Entry."
    )
    failed_data_recovery_in_seconds: Optional[int] = Field(
        None,
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this AutonomousDatabaseSummary. The `OCID`__ of the Autonomous Database. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    in_memory_area_in_gbs: Optional[int] = Field(
        None,
        description="The area assigned to In-Memory tables in Autonomous Database.",
    )
    in_memory_percentage: Optional[int] = Field(
        None,
    ...
    is_dedicated: Optional[bool] = Field(
        None,
        description="True if the database uses `dedicated Exadata infrastructure`__. __ https://docs.oracle.com/en/cloud/paas/autonomous-database/index.html",
    )
    is_dev_tier: Optional[bool] = Field(
        None,
    ...
    is_free_tier: Optional[bool] = Field(
        None,
    ...
    is_local_data_guard_enabled: Optional[bool] = Field(
        None,
    ...
    is_mtls_connection_required: Optional[bool] = Field(
        None,
    ...
    is_remote_data_guard_enabled: Optional[bool] = Field(
        None,
    ...
    kms_key_lifecycle_details: Optional[str] = Field(
        None, description="KMS key lifecycle details."
    )
    kms_key_version_id: Optional[str] = Field(
        None,
        description="The OCID of the key container version that is used in database transparent data encryption (TDE) operations KMS Key can have multiple key versions. If none is specified, the current key version (latest) of the Key Id is used for the operation. Autonomous Database Serverless does not use key versions, hence is not applicable for Autonomous Database Serverless instances.",
    )
    license_model: Optional[str] = Field(
        None,
    ...
    lifecycle_details: Optional[str] = Field(
        None, description="Information about the current lifecycle state."
    )
    lifecycle_state: Optional[str] = Field(
        None,
    ...
    local_adg_auto_failover_max_data_loss_limit: Optional[int] = Field(
        None,
    ...
    local_disaster_recovery_type: Optional[str] = Field(
        None,
    ...
    local_standby_db: Optional[dict] = Field(None, description="")
    long_term_backup_schedule: Optional[int] = Field(None, description="")
    memory_per_oracle_compute_unit_in_gbs: Optional[int] = Field(
        None, description="The amount of memory (in GBs) enabled per ECPU or OCPU."
    )
    ncharacter_set: Optional[str] = Field(
        None,
    ...
    next_long_term_backup_time_stamp: Optional[datetime] = Field(
        None,
        description="The date and time when the next long-term backup would be created.",
    )
    nsg_ids: Optional[str] = Field(
        None,
    ...
    operations_insights_status: Optional[str] = Field(
        None,
    ...
    peer_db_ids: Optional[str] = Field(
        None,
        description="The list of `OCIDs`__ of standby databases located in Autonomous Data Guard remote regions that are associated with the source database. Note that for Autonomous Database Serverless instances, standby databases located in the same region as the source primary database do not have OCIDs. __ https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm",
    )
    ...
    private_endpoint: Optional[str] = Field(
        None, description="The private endpoint for the resource."
    )
    private_endpoint_ip: Optional[str] = Field(
        None, description="The private endpoint Ip address for the resource."
    )
    private_endpoint_label: Optional[str] = Field(
        None,
    ...
    public_connection_urls: Optional[dict] = Field(
        None,
    ...
    refreshable_mode: Optional[str] = Field(
        None,
    ...
    refreshable_status: Optional[str] = Field(
        None,
    ...
    remote_disaster_recovery_configuration: Optional[dict] = Field(None, description="")
    resource_pool_leader_id: Optional[str] = Field(
        None,
        description="The unique identifier for leader autonomous database OCID `OCID`__. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    resource_pool_summary: Optional[dict] = Field(None, description="")
    role: Optional[str] = Field(
        None,
        description='The Data Guard role of the Autonomous Container Database or Autonomous Database, if Autonomous Data Guard is enabled. Allowed values for this property are: "PRIMARY", "STANDBY", "DISABLED_STANDBY", "BACKUP_COPY", "SNAPSHOT_STANDBY", \'UNKNOWN_ENUM_VALUE\'. Any unrecognized values returned by a service will be mapped to \'UNKNOWN_ENUM_VALUE\'.',
    )
    scheduled_operations: Optional[list[dict]] = Field(
        None,
    ...
    security_attributes: Optional[str] = Field(
        None,
        description='Security Attributes for this resource. Each key is predefined and scoped to a namespace. For more information, see `Resource Tags`__. Example: `{"Oracle-ZPR": {"MaxEgressCount": {"value": "42", "mode": "audit"}}}` __ https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm',
    )
    service_console_url: Optional[str] = Field(
        None, description="The URL of the Service Console for the Autonomous Database."
    )
    source_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the source Autonomous Database that was cloned to create the current Autonomous Database. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    standby_db: Optional[dict] = Field(
        None,
        description="**Deprecated** Autonomous Data Guard standby database details.",
    )
    standby_whitelisted_ips: Optional[str] = Field(
        None,
    ...
    subscription_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the subscription with which resource needs to be associated with. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    supported_regions_to_clone_to: Optional[str] = Field(
        None,
    ...
    system_tags: Optional[str] = Field(
        None,
        description="System tags for this resource. Each key is predefined and scoped to a namespace. For more information, see `Resource Tags`__. __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm",
    )
    time_created: Optional[datetime] = Field(
        None, description="The date and time the Autonomous Database was created."
    )
    time_data_guard_role_changed: Optional[datetime] = Field(
        None,
        description='The date and time the Autonomous Data Guard role was switched for the Autonomous Database. For databases that have standbys in both the primary Data Guard region and a remote Data Guard standby region, this is the latest timestamp of either the database using the "primary" role in the primary Data Guard region, or database located in the remote Data Guard standby region.',
    )
    time_deletion_of_free_autonomous_database: Optional[datetime] = Field(
        None,
    ...
    time_disaster_recovery_role_changed: Optional[datetime] = Field(
        None,
        description="The date and time the Disaster Recovery role was switched for the standby Autonomous Database.",
    )
    time_local_data_guard_enabled: Optional[datetime] = Field(
        None,
    ...
    time_maintenance_begin: Optional[datetime] = Field(
        None, description="The date and time when maintenance will begin."
    )
    time_maintenance_end: Optional[datetime] = Field(
        None, description="The date and time when maintenance will end."
    )
    time_of_auto_refresh_start: Optional[datetime] = Field(
        None,
    ...
    time_of_joining_resource_pool: Optional[datetime] = Field(
        None, description="The time the member joined the resource pool."
    )
    time_of_last_failover: Optional[datetime] = Field(
        None, description="The timestamp of the last failover operation."
    )
    time_of_last_refresh: Optional[datetime] = Field(
        None, description="The date and time when last refresh happened."
    )
    time_of_last_refresh_point: Optional[datetime] = Field(
        None,
    ...
    time_of_last_switchover: Optional[datetime] = Field(
        None,
        description="The timestamp of the last switchover operation for the Autonomous Database.",
    )
    time_of_next_refresh: Optional[datetime] = Field(
        None, description="The date and time of next refresh."
    )
    time_reclamation_of_free_autonomous_database: Optional[datetime] = Field(
        None,
    ...
    time_undeleted: Optional[datetime] = Field(
        None,
        description="The date and time the Autonomous Database was most recently undeleted.",
    )
    time_until_reconnect_clone_enabled: Optional[datetime] = Field(
        None,
    ...
    total_backup_storage_size_in_gbs: Optional[float] = Field(
        None, description="The backup storage to the database."
    )
    used_data_storage_size_in_gbs: Optional[int] = Field(
        None, description="The storage space consumed by Autonomous Database in GBs."
    )
    used_data_storage_size_in_tbs: Optional[int] = Field(
        None,
    ...
    whitelisted_ips: Optional[str] = Field(
        None,
        description='The client IP access control list (ACL). This feature is available for `Autonomous Database Serverless]`__ and on Exadata Cloud@Customer. Only clients connecting from an IP address included in the ACL may access the Autonomous Database instance. If `arePrimaryWhitelistedIpsUsed` is \'TRUE\' then Autonomous Database uses this primary\'s IP access control list (ACL) for the disaster recovery peer called `standbywhitelistedips`. For Autonomous Database Serverless, this is an array of CIDR (classless inter-domain routing) notations for a subnet or VCN OCID (virtual cloud network Oracle Cloud ID). Multiple IPs and VCN OCIDs should be separate strings separated by commas, but if it’s other configurations that need multiple pieces of information then its each piece is connected with semicolon (;) as a delimiter. Example: `["1.1.1.1","1.1.1.0/24","ocid1.vcn.oc1.sea.<unique_id>","ocid1.vcn.oc1.sea.<unique_id1>;1.1.1.1","ocid1.vcn.oc1.sea.<unique_id2>;1.1.0.0/16"]` For Exadata Cloud@Customer, this is an array of IP addresses or CIDR notations. Example: `["1.1.1.1","1.1.1.0/24","1.1.2.25"]` For an update operation, if you want to delete all the IPs in the ACL, use an array with a single empty string entry. This cannot be updated in parallel with any of the following: licenseModel, dbEdition, cpuCoreCount, computeCount, computeModel, adminPassword, isMTLSConnectionRequired, openMode, permissionLevel, dbWorkload, dbVersion, isRefreshable, dbName, scheduledOperations, dbToolsDetails, isLocalDataGuardEnabled, or isFreeTier. __ https://docs.oracle.com/en/cloud/paas/autonomous-database/index.html',
    )
...
class AutonomousDatabaseDataguardAssociation(OCIBaseModel):
    ...
    autonomous_database_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the autonomous_database_id of this AutonomousDatabaseDataguardAssociation. The `OCID`__ of the Autonomous Database that has a relationship with the peer Autonomous Database. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    id: Optional[str] = Field(
        None,
    ...
    peer_autonomous_database_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the peer Autonomous Database. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    peer_autonomous_database_life_cycle_state: Optional[str] = Field(
        None,
    ...
    time_created: Optional[datetime] = Field(
        None, description="The date and time the Data Guard association was created."
    )
    time_last_role_changed: Optional[datetime] = Field(
        None, description="The date and time when the last role change action happened."
    )
...
class AutonomousDbPreviewVersionSummary(OCIBaseModel):
    ...
    time_preview_begin: Optional[datetime] = Field(
        None,
        description="The date and time when the preview version availability begins.",
    )
    time_preview_end: Optional[datetime] = Field(
        None,
...
class AutonomousVirtualMachineSummary(OCIBaseModel):
    ...
    autonomous_vm_cluster_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the Autonomous VM Cluster associated with the Autonomous Virtual Machine. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    client_ip_address: Optional[str] = Field(None, description="Client IP Address.")
    cloud_autonomous_vm_cluster_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the Cloud Autonomous VM Cluster associated with the Autonomous Virtual Machine. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    compartment_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    ...
    db_node_storage_size_in_gbs: Optional[int] = Field(
        None,
        description="The allocated local node storage in GBs on the Autonomous Virtual Machine.",
    )
    db_server_display_name: Optional[str] = Field(
        None,
        description="The display name of the dbServer associated with the Autonomous Virtual Machine.",
    )
    db_server_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the Db server associated with the Autonomous Virtual Machine. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    defined_tags: Optional[str] = Field(
        None,
        description="Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see `Resource Tags`__. __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm",
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this AutonomousVirtualMachineSummary. The `OCID`__ of the Autonomous Virtual Machine. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    lifecycle_state: Optional[str] = Field(
        None,
...
class AutonomousVmClusterSummary(OCIBaseModel):
    ...
    available_container_databases: Optional[int] = Field(
        None,
        description="The number of Autonomous Container Databases that can be created with the currently available local storage.",
    )
    available_cpus: Optional[int] = Field(
        None, description="The numnber of CPU cores available."
    )
    ...
    compartment_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the compartment_id of this AutonomousVmClusterSummary. The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    compute_model: Optional[str] = Field(
        None,
        description="The compute model of the Autonomous VM Cluster. ECPU compute model is the recommended model and OCPU compute model is legacy. See `Compute Models in Autonomous Database on Dedicated Exadata #Infrastructure`__ for more details. __ https://docs.oracle.com/en/cloud/paas/autonomous-database/dedicated/adbak Allowed values for this property are: \"ECPU\", \"OCPU\", 'UNKNOWN_ENUM_VALUE'. Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.",
    )
    cpu_core_count_per_node: Optional[int] = Field(
        None, description="The number of CPU cores enabled per VM cluster node."
    )
    cpu_percentage: Optional[float] = Field(
        None,
        description="The percentage of total number of CPUs used in an Autonomous VM Cluster.",
    )
    cpus_enabled: Optional[int] = Field(
        None, description="The number of enabled CPU cores."
    )
    cpus_lowest_scaled_value: Optional[int] = Field(
        None, description="The lowest value to which cpus can be scaled down."
    )
    data_storage_size_in_gbs: Optional[float] = Field(
        None, description="The total data storage allocated in GBs."
    )
    data_storage_size_in_tbs: Optional[float] = Field(
        None, description="The total data storage allocated in TBs"
    )
    db_node_storage_size_in_gbs: Optional[int] = Field(
        None, description="The local node storage allocated in GBs."
    )
    db_servers: Optional[str] = Field(
        None,
        description="The list of `OCIDs`__ of the Db servers. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    defined_tags: Optional[str] = Field(
        None,
        description="Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see `Resource Tags`__. __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm",
    ...
    exadata_infrastructure_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the exadata_infrastructure_id of this AutonomousVmClusterSummary. The `OCID`__ of the Exadata infrastructure. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this AutonomousVmClusterSummary. The `OCID`__ of the Autonomous VM cluster. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    is_local_backup_enabled: Optional[bool] = Field(
        None,
    ...
    is_mtls_enabled: Optional[bool] = Field(
        None,
    ...
    maintenance_window: Optional[int] = Field(None, description="")
    max_acds_lowest_scaled_value: Optional[int] = Field(
        None,
    ...
    memory_size_in_gbs: Optional[int] = Field(
        None, description="The memory allocated in GBs."
    )
    next_maintenance_run_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the next maintenance run. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    ...
    node_count: Optional[int] = Field(
        None, description="The number of nodes in the Autonomous VM Cluster."
    )
    non_provisionable_autonomous_container_databases: Optional[int] = Field(
        None,
    ...
    ocpus_enabled: Optional[float] = Field(
        None, description="The number of enabled OCPU cores."
    )
    provisionable_autonomous_container_databases: Optional[int] = Field(
        None, description="**Deprecated.** Use field totalContainerDatabases."
    )
    provisioned_autonomous_container_databases: Optional[int] = Field(
        None,
        description="The number of provisioned Autonomous Container Databases in an Autonomous VM Cluster.",
    )
    provisioned_cpus: Optional[float] = Field(
        None, description="The number of CPUs provisioned in an Autonomous VM Cluster."
    )
    reclaimable_cpus: Optional[int] = Field(
        None,
        description="CPUs that continue to be included in the count of CPUs available to the Autonomous Container Database even after one of its Autonomous Database is terminated or scaled down. You can release them to the available CPUs at its parent Autonomous VM Cluster level by restarting the Autonomous Container Database.",
    )
    reserved_cpus: Optional[float] = Field(
        None, description="The number of CPUs reserved in an Autonomous VM Cluster."
    )
    scan_listener_port_non_tls: Optional[int] = Field(
        None,
        description="The SCAN Listener Non TLS port number. Default value is 1521.",
    )
    scan_listener_port_tls: Optional[int] = Field(
        None, description="The SCAN Listener TLS port number. Default value is 2484."
    )
    time_created: Optional[datetime] = Field(
        None,
        description="The date and time that the Autonomous VM cluster was created.",
    )
    time_database_ssl_certificate_expires: Optional[datetime] = Field(
        None,
        description="The date and time of the Database SSL certificate expiration.",
    )
    time_ords_certificate_expires: Optional[datetime] = Field(
        None, description="The date and time of the ORDS certificate expiration."
    )
    time_zone: Optional[str] = Field(
        None,
        description="The time zone to use for the Autonomous VM cluster. For details, see `DB System Time Zones`__. __ https://docs.cloud.oracle.com/Content/Database/References/timezones.htm",
    )
    ...
    total_container_databases: Optional[int] = Field(
        None,
        description="The total number of Autonomous Container Databases that can be created.",
    )
    vm_cluster_network_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the vm_cluster_network_id of this AutonomousVmClusterSummary. The `OCID`__ of the VM cluster network. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
...
class BackupDestinationSummary(OCIBaseModel):
    ...
    associated_databases: Optional[list[dict]] = Field(
        None, description="List of databases associated with the backup destination."
    )
    compartment_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    ...
    display_name: Optional[str] = Field(
        None, description="The user-provided name of the backup destination."
    )
    freeform_tags: Optional[str] = Field(
        None,
        description='Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see `Resource Tags`__. Example: `{"Department": "Finance"}` __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm',
    ...
    id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the backup destination. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    lifecycle_details: Optional[str] = Field(
        None,
    ...
    local_mount_point_path: Optional[str] = Field(
        None,
    ...
    nfs_mount_type: Optional[str] = Field(
        None,
    ...
    nfs_server: Optional[str] = Field(
        None, description="Host names or IP addresses for NFS Auto mount."
    )
    nfs_server_export: Optional[str] = Field(
        None, description="Specifies the directory on which to mount the file system"
    )
    ...
    time_created: Optional[datetime] = Field(
        None, description="The date and time the backup destination was created."
    )
    total_storage_size_in_gbs: Optional[int] = Field(
        None,
...
class BackupSummary(OCIBaseModel):
    ...
    database_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the database. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    ...
    encryption_key_location_details: Optional[dict] = Field(None, description="")
    id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the backup. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    key_store_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the key store of Oracle Vault. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    ...
    shape: Optional[str] = Field(
        None, description="Shape of the backup's source database."
    )
    time_ended: Optional[datetime] = Field(
        None, description="The date and time the backup was completed."
    )
    time_started: Optional[datetime] = Field(
        None, description="The date and time the backup started."
    )
    ...
    version: Optional[str] = Field(
        None, description="Version of the backup's source database"
    )
...
class CloudAutonomousVmClusterSummary(OCIBaseModel):
    ...
    available_cpus: Optional[float] = Field(
        None, description="CPU cores available for allocation to Autonomous Databases."
    )
    cloud_exadata_infrastructure_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the cloud_exadata_infrastructure_id of this CloudAutonomousVmClusterSummary. The `OCID`__ of the cloud Exadata infrastructure. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    cluster_time_zone: Optional[str] = Field(
        None, description="The time zone of the Cloud Autonomous VM Cluster."
    )
    compartment_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the compartment_id of this CloudAutonomousVmClusterSummary. The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    compute_model: Optional[str] = Field(
        None,
    ...
    cpu_core_count: Optional[int] = Field(
        None, description="The number of CPU cores on the cloud Autonomous VM cluster."
    )
    cpu_core_count_per_node: Optional[int] = Field(
        None, description="The number of CPU cores enabled per VM cluster node."
    )
    ...
    data_storage_size_in_gbs: Optional[float] = Field(
        None, description="The total data storage allocated, in gigabytes (GB)."
    )
    data_storage_size_in_tbs: Optional[float] = Field(
        None, description="The total data storage allocated, in terabytes (TB)."
    )
    db_node_storage_size_in_gbs: Optional[int] = Field(
        None, description="The local node storage allocated in GBs."
    )
    ...
    description: Optional[str] = Field(
        None, description="User defined description of the cloud Autonomous VM cluster."
    )
    display_name: Optional[str] = Field(
        None,
    ...
    domain: Optional[str] = Field(
        None, description="The domain name for the cloud Autonomous VM cluster."
    )
    exadata_storage_in_tbs_lowest_scaled_value: Optional[float] = Field(
        None,
        description="The lowest value to which exadataStorage (in TBs) can be scaled down.",
    ...
    hostname: Optional[str] = Field(
        None, description="The hostname for the cloud Autonomous VM cluster."
    )
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this CloudAutonomousVmClusterSummary. The `OCID`__ of the Cloud Autonomous VM cluster. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    is_mtls_enabled_vm_cluster: Optional[bool] = Field(
        None,
    ...
    last_update_history_entry_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the last maintenance update history. This value is updated when a maintenance update starts. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    license_model: Optional[str] = Field(
        None,
        description="The Oracle license model that applies to the Oracle Autonomous Database. Bring your own license (BYOL) allows you to apply your current on-premises Oracle software licenses to equivalent, highly automated Oracle services in the cloud. License Included allows you to subscribe to new Oracle Database software licenses and the Oracle Database service. Note that when provisioning an `Autonomous Database on dedicated Exadata infrastructure`__, this attribute must be null. It is already set at the Autonomous Exadata Infrastructure level. When provisioning an `Autonomous Database Serverless]`__ database, if a value is not specified, the system defaults the value to `BRING_YOUR_OWN_LICENSE`. Bring your own license (BYOL) also allows you to select the DB edition using the optional parameter. This cannot be updated in parallel with any of the following: cpuCoreCount, computeCount, dataStorageSizeInTBs, adminPassword, isMTLSConnectionRequired, dbWorkload, privateEndpointLabel, nsgIds, dbVersion, dbName, scheduledOperations, dbToolsDetails, or isFreeTier. __ https://docs.oracle.com/en/cloud/paas/autonomous-database/index.html __ https://docs.oracle.com/en/cloud/paas/autonomous-database/index.html Allowed values for this property are: \"LICENSE_INCLUDED\", \"BRING_YOUR_OWN_LICENSE\", 'UNKNOWN_ENUM_VALUE'. Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.",
    ...
    memory_per_oracle_compute_unit_in_gbs: Optional[int] = Field(
        None, description="The amount of memory (in GBs) enabled per OCPU or ECPU."
    )
    memory_size_in_gbs: Optional[int] = Field(
        None, description="The memory allocated in GBs."
    )
    ...
    node_count: Optional[int] = Field(
        None, description="The number of database servers in the cloud VM cluster."
    )
    non_provisionable_autonomous_container_databases: Optional[int] = Field(
        None,
        description="The number of non-provisionable Autonomous Container Databases in an Autonomous VM Cluster.",
    ...
    ocpus_lowest_scaled_value: Optional[int] = Field(
        None, description="The lowest value to which ocpus can be scaled down."
    )
    provisionable_autonomous_container_databases: Optional[int] = Field(
        None,
    ...
    scan_listener_port_non_tls: Optional[int] = Field(
        None, description="The SCAN Listener Non TLS port. Default is 1521."
    )
    scan_listener_port_tls: Optional[int] = Field(
        None, description="The SCAN Listenenr TLS port. Default is 2484."
    )
    security_attributes: Optional[str] = Field(
        None,
        description='Security Attributes for this resource. Each key is predefined and scoped to a namespace. For more information, see `Resource Tags`__. Example: `{"Oracle-ZPR": {"MaxEgressCount": {"value": "42", "mode": "audit"}}}` __ https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm',
    ...
    time_database_ssl_certificate_expires: Optional[datetime] = Field(
        None, description="The date and time of Database SSL certificate expiration."
    )
    time_ords_certificate_expires: Optional[datetime] = Field(
        None, description="The date and time of ORDS certificate expiration."
    )
    ...
    total_cpus: Optional[float] = Field(
        None, description="The total number of CPUs in an Autonomous VM Cluster."
    )
...
class CloudExadataInfrastructureSummary(OCIBaseModel):
    ...
    available_storage_size_in_gbs: Optional[int] = Field(
        None,
        description="The available storage can be allocated to the cloud Exadata infrastructure resource, in gigabytes (GB).",
    )
    cluster_placement_group_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the cluster placement group of the Exadata Infrastructure. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    compartment_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the compartment_id of this CloudExadataInfrastructureSummary. The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    compute_count: Optional[int] = Field(
        None,
    ...
    cpu_count: Optional[int] = Field(
        None, description="The total number of CPU cores allocated."
    )
    customer_contacts: Optional[list[str]] = Field(
        None,
    ...
    data_storage_size_in_tbs: Optional[float] = Field(
        None, description="Size, in terabytes, of the DATA disk group."
    )
    database_server_type: Optional[str] = Field(
        None, description="The database server type of the Exadata infrastructure."
    )
    db_node_storage_size_in_gbs: Optional[int] = Field(
        None, description="The local node storage allocated in GBs."
    )
    db_server_version: Optional[str] = Field(
        None,
        description="The software version of the database servers (dom0) in the cloud Exadata infrastructure. Example: 20.1.15",
    )
    defined_file_system_configurations: Optional[list[dict]] = Field(
        None,
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this CloudExadataInfrastructureSummary. The `OCID`__ of the cloud Exadata infrastructure resource. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    is_scheduling_policy_associated: Optional[bool] = Field(
        None,
    ...
    maintenance_window: Optional[int] = Field(None, description="")
    max_cpu_count: Optional[int] = Field(
        None, description="The total number of CPU cores available."
    )
    max_data_storage_in_tbs: Optional[float] = Field(
        None, description="The total available DATA disk group size."
    )
    max_db_node_storage_in_gbs: Optional[int] = Field(
        None, description="The total local node storage available in GBs."
    )
    max_memory_in_gbs: Optional[int] = Field(
        None, description="The total memory available in GBs."
    )
    memory_size_in_gbs: Optional[int] = Field(
        None, description="The memory allocated in GBs."
    )
    monthly_db_server_version: Optional[str] = Field(
        None,
    ...
    monthly_storage_server_version: Optional[str] = Field(
        None,
    ...
    storage_count: Optional[int] = Field(
        None,
        description="The number of storage servers for the cloud Exadata infrastructure.",
    )
    storage_server_type: Optional[str] = Field(
        None, description="The storage server type of the Exadata infrastructure."
    )
    storage_server_version: Optional[str] = Field(
        None,
...
class UpdateSummary(OCIBaseModel):
    ...
    available_actions: Optional[str] = Field(
        None,
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this UpdateSummary. The `OCID`__ of the maintenance update. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    ...
    time_released: Optional[datetime] = Field(
        None,
...
class CloudVmClusterSummary(OCIBaseModel):
    ...
    backup_network_nsg_ids: Optional[str] = Field(
        None,
    ...
    backup_subnet_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the backup network subnet associated with the cloud VM cluster. **Subnet Restriction:** See the subnet restrictions information for **subnetId**. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    cloud_automation_update_details: Optional[datetime] = Field(None, description="")
    cloud_exadata_infrastructure_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the cloud_exadata_infrastructure_id of this CloudVmClusterSummary. The `OCID`__ of the cloud Exadata infrastructure. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    ...
    compartment_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the compartment_id of this CloudVmClusterSummary. The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    compute_model: Optional[str] = Field(
        None,
        description="The compute model of the Autonomous Database. This is required if using the `computeCount` parameter. If using `cpuCoreCount` then it is an error to specify `computeModel` to a non-null value. ECPU compute model is the recommended model and OCPU compute model is legacy. Allowed values for this property are: \"ECPU\", \"OCPU\", 'UNKNOWN_ENUM_VALUE'. Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.",
    ...
    data_collection_options: Optional[dict] = Field(None, description="")
    data_storage_percentage: Optional[int] = Field(
        None,
        description="The percentage assigned to DATA storage (user data and database files). The remaining percentage is assigned to RECO storage (database redo logs, archive logs, and recovery manager backups). Accepted values are 35, 40, 60 and 80. The default is 80 percent assigned to DATA storage. See `Storage Configuration`__ in the Exadata documentation for details on the impact of the configuration settings on storage. __ https://docs.cloud.oracle.com/Content/Database/Concepts/exaoverview.htm#Exadata",
    )
    data_storage_size_in_tbs: Optional[float] = Field(
        None, description="The data disk group size to be allocated in TBs."
    )
    db_node_storage_size_in_gbs: Optional[int] = Field(
        None, description="The local node storage to be allocated in GBs."
    )
    db_servers: Optional[str] = Field(None, description="The list of DB servers.")
    defined_tags: Optional[str] = Field(
        None,
        description="Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see `Resource Tags`__. __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm",
    )
    disk_redundancy: Optional[str] = Field(
        None,
    ...
    file_system_configuration_details: Optional[list[dict]] = Field(
        None, description="Details of the file system configuration of the VM cluster."
    )
    freeform_tags: Optional[str] = Field(
        None,
        description='Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see `Resource Tags`__. Example: `{"Department": "Finance"}` __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm',
    )
    gi_software_image_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of a grid infrastructure software image. This is a database software image of the type `GRID_IMAGE`. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    gi_version: Optional[str] = Field(
        None, description="A valid Oracle Grid Infrastructure (GI) software version."
    )
    hostname: Optional[str] = Field(
        None,
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this CloudVmClusterSummary. The `OCID`__ of the cloud VM cluster. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    is_local_backup_enabled: Optional[bool] = Field(
        None,
    ...
    is_sparse_diskgroup_enabled: Optional[bool] = Field(
        None,
        description="If true, sparse disk group is configured for the cloud VM cluster. If false, sparse disk group is not created.",
    )
    last_update_history_entry_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the last maintenance update history entry. This value is updated when a maintenance update starts. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    license_model: Optional[str] = Field(
        None,
    ...
    listener_port: Optional[int] = Field(
        None,
        description="The port number configured for the listener on the cloud VM cluster.",
    )
    memory_size_in_gbs: Optional[int] = Field(
        None, description="The memory to be allocated in GBs."
    )
    node_count: Optional[int] = Field(
        None, description="The number of nodes in the cloud VM cluster."
    )
    nsg_ids: Optional[str] = Field(
        None,
        description="The list of `OCIDs`__ for the network security groups (NSGs) to which this resource belongs. Setting this to an empty list removes all resources from all NSGs. For more information about NSGs, see `Security Rules`__. **NsgIds restrictions:** - A network security group (NSG) is optional for Autonomous Databases with private access. The nsgIds list can be empty. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm __ https://docs.cloud.oracle.com/Content/Network/Concepts/securityrules.htm",
    ...
    scan_dns_name: Optional[str] = Field(
        None,
        description="The FQDN of the DNS record for the SCAN IP addresses that are associated with the cloud VM cluster.",
    )
    scan_dns_record_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the DNS record for the SCAN IP addresses that are associated with the cloud VM cluster. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    scan_ip_ids: Optional[str] = Field(
        None,
    ...
    scan_listener_port_tcp: Optional[int] = Field(
        None,
        description="The TCP Single Client Access Name (SCAN) port. The default port is 1521.",
    )
    scan_listener_port_tcp_ssl: Optional[int] = Field(
        None,
    ...
    ssh_public_keys: Optional[str] = Field(
        None,
    ...
    storage_size_in_gbs: Optional[int] = Field(
        None,
    ...
    system_version: Optional[str] = Field(
        None, description="Operating system version of the image."
    )
    time_created: Optional[datetime] = Field(
        None, description="The date and time that the cloud VM cluster was created."
    )
    time_zone: Optional[str] = Field(
        None,
        description="The time zone of the cloud VM cluster. For details, see `Exadata Infrastructure Time Zones`__. __ https://docs.cloud.oracle.com/Content/Database/References/timezones.htm",
    )
    vip_ids: Optional[str] = Field(
        None,
...
class ConsoleConnectionSummary(OCIBaseModel):
    ...
    service_host_key_fingerprint: Optional[str] = Field(
        None,
...
class AutonomousPatchSummary(OCIBaseModel):
    ...
    autonomous_patch_type: Optional[str] = Field(
        None,
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this AutonomousPatchSummary. The `OCID`__ of the patch. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    lifecycle_details: Optional[str] = Field(
        None,
    ...
    quarter: Optional[str] = Field(
        None, description="First month of the quarter in which the patch was released."
    )
    time_released: Optional[datetime] = Field(
        None,
    ...
    year: Optional[str] = Field(
        None, description="Year in which the patch was released."
    )
...
class DataGuardAssociationSummary(OCIBaseModel):
    ...
    database_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the database_id of this DataGuardAssociationSummary. The `OCID`__ of the reporting database. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this DataGuardAssociationSummary. The `OCID`__ of the Data Guard association. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    is_active_data_guard_enabled: Optional[bool] = Field(
        None, description="True if active Data Guard is enabled."
    )
    lifecycle_details: Optional[str] = Field(
        None,
        description="Additional information about the current lifecycleState, if available.",
    ...
    peer_data_guard_association_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the peer database's Data Guard association. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    peer_database_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the associated peer database. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    peer_db_home_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the Database Home containing the associated peer database. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    peer_db_system_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the peer_db_system_id of this DataGuardAssociationSummary. The `OCID`__ of the DB system containing the associated peer database. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    peer_role: Optional[str] = Field(
        None,
...
class DatabaseSoftwareImageSummary(OCIBaseModel):
    ...
    compartment_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the compartment_id of this DatabaseSoftwareImageSummary. The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    database_software_image_included_patches: Optional[str] = Field(
        None, description="List of one-off patches for Database Homes."
    )
    database_software_image_one_off_patches: Optional[str] = Field(
        None, description="List of one-off patches for Database Homes."
    )
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this DatabaseSoftwareImageSummary. The `OCID`__ of the database software image. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    image_shape_family: Optional[str] = Field(
        None,
    ...
    included_patches_summary: Optional[str] = Field(
        None,
        description="The patches included in the image and the version of the image.",
    )
    is_upgrade_supported: Optional[bool] = Field(
        None,
...
class DatabaseSummary(OCIBaseModel):
    ...
    character_set: Optional[str] = Field(
        None, description="The character set for the database."
    )
    compartment_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the compartment_id of this DatabaseSummary. The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    connection_strings: Optional[str] = Field(
        None,
        description="The Connection strings used to connect to the Oracle Database.",
    )
    data_guard_group: Optional[dict] = Field(None, description="")
    database_management_config: Optional[dict] = Field(None, description="")
    database_software_image_id: Optional[str] = Field(
        None,
        description="The database software image `OCID`__ __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    db_backup_config: Optional[dict] = Field(None, description="")
    db_home_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the Database Home. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    db_name: Optional[str] = Field(
        None,
    ...
    db_system_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the DB system. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    db_unique_name: Optional[str] = Field(
        None,
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this DatabaseSummary. The `OCID`__ of the database. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    is_cdb: Optional[bool] = Field(
        None, description="True if the database is a container database."
    )
    key_store_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the key store of Oracle Vault. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    ...
    last_backup_duration_in_seconds: Optional[int] = Field(
        None, description="The duration when the latest database backup created."
    )
    last_backup_timestamp: Optional[datetime] = Field(
        None,
        description="The date and time when the latest database backup was created.",
    )
    last_failed_backup_timestamp: Optional[datetime] = Field(
        None, description="The date and time when the latest database backup failed."
    )
    lifecycle_details: Optional[str] = Field(
        None, description="Additional information about the current lifecycle state."
    )
    ...
    ncharacter_set: Optional[str] = Field(
        None, description="The national character set for the database."
    )
    ...
    sid_prefix: Optional[str] = Field(
        None,
        description="Specifies a prefix for the `Oracle SID` of the database to be created.",
    )
    source_database_point_in_time_recovery_timestamp: Optional[datetime] = Field(
        None,
        description="Point in time recovery timeStamp of the source database at which cloned database system is cloned from the source database system, as described in `RFC 3339`__ __ https://tools.ietf.org/rfc/rfc3339",
    )
    time_created: Optional[datetime] = Field(
        None, description="The date and time the database was created."
    )
    vault_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the Oracle Cloud Infrastructure `vault`__. This parameter and `secretId` are required for Customer Managed Keys. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm __ https://docs.cloud.oracle.com/Content/KeyManagement/Concepts/keyoverview.htm#concepts",
    )
    vm_cluster_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the VM cluster. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
...
class PatchHistoryEntrySummary(OCIBaseModel):
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this PatchHistoryEntrySummary. The `OCID`__ of the patch history entry. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    lifecycle_details: Optional[str] = Field(
        None,
        description="A descriptive text associated with the lifecycleState. Typically contains additional displayable text.",
    ...
    patch_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the patch_id of this PatchHistoryEntrySummary. The `OCID`__ of the patch. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    ...
    time_ended: Optional[datetime] = Field(
        None, description="The date and time when the patch action completed"
    )
    time_started: Optional[datetime] = Field(
        None,
...
class PatchSummary(OCIBaseModel):
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this PatchSummary. The `OCID`__ of the patch. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    last_action: Optional[str] = Field(
        None,
...
class DbHomeSummary(OCIBaseModel):
    ...
    compartment_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the compartment_id of this DbHomeSummary. The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    database_software_image_id: Optional[str] = Field(
        None,
        description="The database software image `OCID`__ __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    db_home_location: Optional[str] = Field(
        None,
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this DbHomeSummary. The `OCID`__ of the Database Home. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    is_unified_auditing_enabled: Optional[bool] = Field(
        None, description="Indicates whether unified autiding is enabled or not."
    )
    kms_key_id: Optional[str] = Field(
        None,
        description="The OCID of the key container that is used as the master encryption key in database transparent data encryption (TDE) operations.",
    )
    last_patch_history_entry_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the last patch history. This value is updated as soon as a patch operation is started. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    lifecycle_details: Optional[str] = Field(
        None, description="Additional information about the current lifecycle state."
    )
    ...
    one_off_patches: Optional[str] = Field(
        None, description="List of one-off patches for Database Homes."
    )
    time_created: Optional[datetime] = Field(
        None, description="The date and time the Database Home was created."
    )
    vm_cluster_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the VM cluster. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
...
class DbNodeSummary(OCIBaseModel):
    ...
    additional_details: Optional[str] = Field(
        None, description="Additional information about the planned maintenance."
    )
    backup_ip_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the backup IP address associated with the database node. Use this OCID with either the :func:`get_private_ip` or the :func:`get_public_ip_by_private_ip_id` API to get the IP address needed to make a database connection. **Note:** Applies only to Exadata Cloud Service. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    backup_vnic2_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the second backup VNIC. **Note:** Applies only to Exadata Cloud Service. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    backup_vnic_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the backup VNIC. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    cpu_core_count: Optional[int] = Field(
        None, description="The number of CPU cores enabled on the Db node."
    )
    db_node_storage_size_in_gbs: Optional[int] = Field(
        None, description="The allocated local node storage in GBs on the Db node."
    )
    db_server_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the Exacc Db server associated with the database node. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    db_system_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the db_system_id of this DbNodeSummary. The `OCID`__ of the DB system. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    defined_tags: Optional[str] = Field(
        None,
        description="Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see `Resource Tags`__. __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm",
    ...
    fault_domain: Optional[str] = Field(
        None, description="The name of the Fault Domain the instance is contained in."
    )
    freeform_tags: Optional[str] = Field(
        None,
        description='Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see `Resource Tags`__. Example: `{"Department": "Finance"}` __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm',
    )
    host_ip_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the host IP address associated with the database node. Use this OCID with either the :func:`get_private_ip` or the :func:`get_public_ip_by_private_ip_id` API to get the IP address needed to make a database connection. **Note:** Applies only to Exadata Cloud Service. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    hostname: Optional[str] = Field(
        None, description="The host name for the database node."
    )
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this DbNodeSummary. The `OCID`__ of the database node. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    lifecycle_details: Optional[str] = Field(
        None, description="Information about the current lifecycle state."
    )
    ...
    memory_size_in_gbs: Optional[int] = Field(
        None, description="The allocated memory in GBs on the Db node."
    )
    software_storage_size_in_gb: Optional[int] = Field(
        None,
    ...
    time_maintenance_window_end: Optional[datetime] = Field(
        None, description="End date and time of maintenance window."
    )
    time_maintenance_window_start: Optional[datetime] = Field(
        None, description="Start date and time of maintenance window."
    )
    total_cpu_core_count: Optional[int] = Field(
        None, description="The total number of CPU cores reserved on the Db node."
    )
    vnic2_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the second VNIC. **Note:** Applies only to Exadata Cloud Service. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    vnic_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the vnic_id of this DbNodeSummary. The `OCID`__ of the VNIC. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
...
class DbServerSummary(OCIBaseModel):
    ...
    autonomous_virtual_machine_ids: Optional[str] = Field(
        None,
        description="The list of `OCIDs`__ of the Autonomous Virtual Machines associated with the Db server. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    autonomous_vm_cluster_ids: Optional[str] = Field(
        None,
        description="The list of `OCIDs`__ of the Autonomous VM Clusters associated with the Db server. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    compartment_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    ...
    cpu_core_count: Optional[int] = Field(
        None, description="The number of CPU cores enabled on the Db server."
    )
    db_node_ids: Optional[str] = Field(
        None,
        description="The `OCID`__ of the Db nodes associated with the Db server. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    db_node_storage_size_in_gbs: Optional[int] = Field(
        None, description="The allocated local node storage in GBs on the Db server."
    )
    db_server_patching_details: Optional[dict] = Field(None, description="")
    defined_tags: Optional[str] = Field(
        None,
        description="Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see `Resource Tags`__. __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm",
    )
    ...
    exadata_infrastructure_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the Exadata infrastructure. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    freeform_tags: Optional[str] = Field(
        None,
        description='Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see `Resource Tags`__. Example: `{"Department": "Finance"}` __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm',
    ...
    id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the Db server. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    lifecycle_details: Optional[str] = Field(
        None, description="Additional information about the current lifecycle state."
    )
    ...
    memory_size_in_gbs: Optional[int] = Field(
        None, description="The allocated memory in GBs on the Db server."
    )
    shape: Optional[str] = Field(
        None,
    ...
    time_created: Optional[datetime] = Field(
        None, description="The date and time that the Db Server was created."
    )
    vm_cluster_ids: Optional[str] = Field(
        None,
        description="The `OCID`__ of the VM Clusters associated with the Db server. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
...
class DbSystemComputePerformanceSummary(OCIBaseModel):
    ...
    compute_performance_list: Optional[list[dict]] = Field(
        None,
...
class DbSystemShapeSummary(OCIBaseModel):
    ...
    are_server_types_supported: Optional[bool] = Field(
        None,
        description="If true, the shape supports configurable DB and Storage Server types.",
    )
    available_core_count: Optional[int] = Field(
        None,
    ...
    available_core_count_per_node: Optional[int] = Field(
        None,
    ...
    available_data_storage_in_t_bs: Optional[int] = Field(
        None, description="The maximum DATA storage that can be enabled for this shape."
    )
    ...
    available_db_node_per_node_in_gbs: Optional[int] = Field(
        None,
    ...
    available_db_node_storage_in_g_bs: Optional[int] = Field(
        None,
        description="The maximum Db Node storage that can be enabled for this shape.",
    )
    available_memory_in_gbs: Optional[int] = Field(
        None, description="The maximum memory that can be enabled for this shape."
    )
    available_memory_per_node_in_gbs: Optional[int] = Field(
        None,
    ...
    shape: Optional[str] = Field(
        None, description="Deprecated. Use `name` instead of `shape`."
    )
    shape_family: Optional[str] = Field(
        None, description="The family of the shape used for the DB system."
    )
...
class DbSystemStoragePerformanceSummary(OCIBaseModel):
    ...
    data_storage_performance_list: Optional[list[dict]] = Field(
        None,
    ...
    reco_storage_performance_list: Optional[list[dict]] = Field(
        None,
...
class DbSystemSummary(OCIBaseModel):
    ...
    backup_subnet_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the backup network subnet the DB system is associated with. Applicable only to Exadata DB systems. **Subnet Restriction:** See the subnet restrictions information for **subnetId**. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    cluster_name: Optional[str] = Field(
        None,
    ...
    compartment_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the compartment_id of this DbSystemSummary. The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    cpu_core_count: Optional[int] = Field(
        None,
    ...
    db_system_options: Optional[str] = Field(None, description="")
    defined_tags: Optional[str] = Field(
        None,
        description="Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see `Resource Tags`__. __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm",
    )
    ...
    fault_domains: Optional[str] = Field(
        None,
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this DbSystemSummary. The `OCID`__ of the DB system. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    kms_key_id: Optional[str] = Field(
        None,
        description="The OCID of the key container that is used as the master encryption key in database transparent data encryption (TDE) operations.",
    ...
    last_patch_history_entry_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the last patch history. This value is updated as soon as a patch operation starts. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    license_model: Optional[str] = Field(
        None,
    ...
    maintenance_window: Optional[int] = Field(None, description="")
    memory_size_in_gbs: Optional[int] = Field(
        None, description="Memory allocated to the DB system, in gigabytes."
    )
    next_maintenance_run_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the next maintenance run. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    ...
    os_version: Optional[str] = Field(
        None, description="The most recent OS Patch Version applied on the DB system."
    )
    point_in_time_data_disk_clone_timestamp: Optional[datetime] = Field(
        None,
        description="The point in time for a cloned database system when the data disks were cloned from the source database system, as described in `RFC 3339`__. __ https://tools.ietf.org/rfc/rfc3339",
    )
    reco_storage_size_in_gb: Optional[int] = Field(
        None,
    ...
    scan_dns_record_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the DNS record for the SCAN IP addresses that are associated with the DB system. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    scan_ip_ids: Optional[str] = Field(
        None,
    ...
    scan_ipv6_ids: Optional[str] = Field(
        None,
    ...
    source_db_system_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the DB system. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    sparse_diskgroup: Optional[bool] = Field(
        None,
    ...
    storage_volume_performance_mode: Optional[str] = Field(
        None,
    ...
    time_created: Optional[datetime] = Field(
        None, description="The date and time the DB system was created."
    )
    time_zone: Optional[str] = Field(
        None,
        description="The time zone of the DB system. For details, see `DB System Time Zones`__. __ https://docs.cloud.oracle.com/Content/Database/References/timezones.htm",
    )
    version: Optional[str] = Field(
        None, description="The Oracle Database version of the DB system."
    )
    vip_ids: Optional[str] = Field(
        None,
    ...
    zone_id: Optional[str] = Field(
        None, description="The OCID of the zone the DB system is associated with."
    )
...
class DbVersionSummary(OCIBaseModel):
    ...
    supports_pdb: Optional[bool] = Field(
        None,
...
class ExadataInfrastructureSummary(OCIBaseModel):
    ...
    additional_compute_count: Optional[int] = Field(
        None,
        description="The requested number of additional compute servers for the Exadata infrastructure.",
    )
    additional_compute_system_model: Optional[str] = Field(
        None,
    ...
    admin_network_cidr: Optional[str] = Field(
        None, description="The CIDR block for the Exadata administration network."
    )
    availability_domain: Optional[str] = Field(
        None,
        description="The name of the availability domain that the Exadata infrastructure is located in.",
    )
    cloud_control_plane_server1: Optional[str] = Field(
        None, description="The IP address for the first control plane server."
    )
    cloud_control_plane_server2: Optional[str] = Field(
        None, description="The IP address for the second control plane server."
    )
    compartment_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the compartment_id of this ExadataInfrastructureSummary. The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    compute_count: Optional[int] = Field(
        None,
    ...
    contacts: Optional[str] = Field(
        None, description="The list of contacts for the Exadata infrastructure."
    )
    corporate_proxy: Optional[str] = Field(
        None,
    ...
    csi_number: Optional[str] = Field(
        None, description="The CSI Number of the Exadata infrastructure."
    )
    data_storage_size_in_tbs: Optional[float] = Field(
        None, description="Size, in terabytes, of the DATA disk group."
    )
    ...
    dns_server: Optional[str] = Field(
        None, description="The list of DNS server IP addresses. Maximum of 3 allowed."
    )
    exascale_config: Optional[dict] = Field(None, description="")
    freeform_tags: Optional[str] = Field(
        None,
        description='Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see `Resource Tags`__. Example: `{"Department": "Finance"}` __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm',
    )
    gateway: Optional[str] = Field(
        None, description="The gateway for the control plane network."
    )
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this ExadataInfrastructureSummary. The `OCID`__ of the Exadata infrastructure. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    infini_band_network_cidr: Optional[str] = Field(
        None, description="The CIDR block for the Exadata InfiniBand interconnect."
    )
    is_cps_offline_report_enabled: Optional[bool] = Field(
        None,
    ...
    is_multi_rack_deployment: Optional[bool] = Field(
        None, description="Indicates if deployment is Multi-Rack or not."
    )
    is_scheduling_policy_associated: Optional[bool] = Field(
        None,
        description="If true, the infrastructure is using granular maintenance scheduling preference.",
    ...
    maintenance_slo_status: Optional[str] = Field(
        None,
    ...
    max_db_node_storage_in_g_bs: Optional[int] = Field(
        None, description="The total local node storage available in GBs."
    )
    max_memory_in_gbs: Optional[int] = Field(
        None, description="The total memory available in GBs."
    ...
    multi_rack_configuration_file: Optional[str] = Field(
        None, description="The base64 encoded Multi-Rack configuration json file."
    )
    netmask: Optional[str] = Field(
        None, description="The netmask for the control plane network."
    )
    network_bonding_mode_details: Optional[dict] = Field(None, description="")
    next_maintenance_run_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the next maintenance run. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    ntp_server: Optional[str] = Field(
        None, description="The list of NTP server IP addresses. Maximum of 3 allowed."
    )
    rack_serial_number: Optional[str] = Field(
        None, description="The serial number for the Exadata infrastructure."
    )
    shape: Optional[str] = Field(
        None,
    ...
    time_created: Optional[datetime] = Field(
        None, description="The date and time the Exadata infrastructure was created."
    )
    time_zone: Optional[str] = Field(
        None,
        description="The time zone of the Exadata infrastructure. For details, see `Exadata Infrastructure Time Zones`__. __ https://docs.cloud.oracle.com/Content/Database/References/timezones.htm",
    )
...
class ExadbVmClusterUpdateSummary(OCIBaseModel):
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this ExadbVmClusterUpdateSummary. The `OCID`__ of the maintenance update. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    last_action: Optional[str] = Field(
        None,
        description='The previous update action performed. Allowed values for this property are: "ROLLING_APPLY", "NON_ROLLING_APPLY", "PRECHECK", "ROLLBACK", \'UNKNOWN_ENUM_VALUE\'. Any unrecognized values returned by a service will be mapped to \'UNKNOWN_ENUM_VALUE\'.',
...
class ExadbVmClusterSummary(OCIBaseModel):
    ...
    backup_subnet_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the backup_subnet_id of this ExadbVmClusterSummary. The `OCID`__ of the backup network subnet associated with the Exadata VM cluster on Exascale Infrastructure. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    cluster_name: Optional[str] = Field(
        None,
    ...
    compartment_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the compartment_id of this ExadbVmClusterSummary. The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    data_collection_options: Optional[dict] = Field(None, description="")
    defined_tags: Optional[str] = Field(
        None,
    ...
    enabled_e_cpu_count: Optional[int] = Field(
        None,
    ...
    exascale_db_storage_vault_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the exascale_db_storage_vault_id of this ExadbVmClusterSummary. The `OCID`__ of the Exadata Database Storage Vault. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    freeform_tags: Optional[str] = Field(
        None,
        description='Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see `Resource Tags`__. Example: `{"Department": "Finance"}` __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm',
    ...
    grid_image_id: Optional[str] = Field(
        None,
    ...
    grid_image_type: Optional[str] = Field(
        None,
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this ExadbVmClusterSummary. The `OCID`__ of the Exadata VM cluster on Exascale Infrastructure. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    last_update_history_entry_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the last maintenance update history entry. This value is updated when a maintenance update starts. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    ...
    private_zone_id: Optional[str] = Field(
        None,
    ...
    scan_dns_record_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the DNS record for the SCAN IP addresses that are associated with the Exadata VM cluster on Exascale Infrastructure. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    scan_ip_ids: Optional[str] = Field(
        None,
    ...
    snapshot_file_system_storage: Optional[dict] = Field(None, description="")
    ssh_public_keys: Optional[str] = Field(
        None,
    ...
    subnet_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the subnet_id of this ExadbVmClusterSummary. The `OCID`__ of the subnet associated with the Exadata VM cluster on Exascale Infrastructure. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    system_tags: Optional[str] = Field(
        None,
        description="System tags for this resource. Each key is predefined and scoped to a namespace. For more information, see `Resource Tags`__. __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm",
    ...
    time_zone: Optional[str] = Field(
        None,
        description="The time zone to use for the Exadata VM cluster on Exascale Infrastructure. For details, see `Time Zones`__. __ https://docs.cloud.oracle.com/Content/Database/References/timezones.htm",
    )
    total_e_cpu_count: Optional[int] = Field(
        None,
    ...
    total_file_system_storage: Optional[dict] = Field(None, description="")
    vip_ids: Optional[str] = Field(
        None,
    ...
    vm_file_system_storage: Optional[dict] = Field(
        None,
...
class ExascaleDbStorageVaultSummary(OCIBaseModel):
    ...
    additional_flash_cache_in_percent: Optional[int] = Field(
        None,
    ...
    compartment_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the compartment_id of this ExascaleDbStorageVaultSummary. The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    defined_tags: Optional[str] = Field(
        None,
        description="Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see `Resource Tags`__. __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm",
    ...
    description: Optional[str] = Field(
        None, description="Exadata Database Storage Vault description."
    )
    display_name: Optional[str] = Field(
        None,
    ...
    high_capacity_database_storage: Optional[dict] = Field(
        None,
        description="**[Required]** Gets the high_capacity_database_storage of this ExascaleDbStorageVaultSummary.",
    )
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this ExascaleDbStorageVaultSummary. The `OCID`__ of the Exadata Database Storage Vault. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    lifecycle_details: Optional[str] = Field(
        None, description="Additional information about the current lifecycle state."
    )
    ...
    time_zone: Optional[str] = Field(
        None,
        description="The time zone that you want to use for the Exadata Database Storage Vault. For details, see `Time Zones`__. __ https://docs.cloud.oracle.com/Content/Database/References/timezones.htm",
    )
    vm_cluster_count: Optional[int] = Field(
        None,
...
class ExecutionActionSummary(OCIBaseModel):
    ...
    action_members: Optional[list[str]] = Field(
        None, description="List of action members of this execution action."
    )
    action_params: Optional[str] = Field(
        None,
    ...
    compartment_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the compartment_id of this ExecutionActionSummary. The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    defined_tags: Optional[str] = Field(
        None,
        description="Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see `Resource Tags`__. __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm",
    ...
    description: Optional[str] = Field(
        None, description="Description of the execution action."
    )
    display_name: Optional[str] = Field(
        None,
    ...
    estimated_time_in_mins: Optional[int] = Field(
        None, description="The estimated time of the execution action in minutes."
    )
    execution_action_order: Optional[int] = Field(
        None, description="The priority order of the execution action."
    )
    execution_window_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the execution_window_id of this ExecutionActionSummary. The `OCID`__ of the execution window resource the execution action belongs to. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    freeform_tags: Optional[str] = Field(
        None,
        description='Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see `Resource Tags`__. Example: `{"Department": "Finance"}` __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm',
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this ExecutionActionSummary. The `OCID`__ of the execution action. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    lifecycle_details: Optional[str] = Field(
        None, description="Additional information about the current lifecycle state."
    )
    ...
    lifecycle_substate: Optional[str] = Field(
        None,
    ...
    time_created: Optional[datetime] = Field(
        None, description="The date and time the execution action was created."
    )
    time_updated: Optional[datetime] = Field(
        None,
        description="The last date and time that the execution action was updated.",
    )
    total_time_taken_in_mins: Optional[int] = Field(
        None,
...
class ExecutionWindowSummary(OCIBaseModel):
    ...
    compartment_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the compartment_id of this ExecutionWindowSummary. The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    defined_tags: Optional[str] = Field(
        None,
        description="Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see `Resource Tags`__. __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm",
    ...
    description: Optional[str] = Field(
        None, description="Description of the execution window."
    )
    display_name: Optional[str] = Field(
        None,
    ...
    estimated_time_in_mins: Optional[int] = Field(
        None, description="The estimated time of the execution window in minutes."
    )
    execution_resource_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the execution_resource_id of this ExecutionWindowSummary. The `OCID`__ of the execution resource the execution window belongs to. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    freeform_tags: Optional[str] = Field(
        None,
        description='Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see `Resource Tags`__. Example: `{"Department": "Finance"}` __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm',
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this ExecutionWindowSummary. The `OCID`__ of the execution window. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    is_enforced_duration: Optional[bool] = Field(
        None,
    ...
    time_created: Optional[datetime] = Field(
        None, description="The date and time the execution window was created."
    )
    time_ended: Optional[datetime] = Field(
        None, description="The date and time that the execution window ended."
    )
    time_scheduled: Optional[datetime] = Field(
        None,
    ...
    time_started: Optional[datetime] = Field(
        None, description="The date and time that the execution window was started."
    )
    time_updated: Optional[datetime] = Field(
        None,
    ...
    window_duration_in_mins: Optional[int] = Field(
        None,
...
class ExternalContainerDatabaseSummary(OCIBaseModel):
    ...
    character_set: Optional[str] = Field(
        None, description="The character set of the external database."
    )
    compartment_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the compartment_id of this ExternalContainerDatabaseSummary. The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    database_configuration: Optional[str] = Field(
        None,
    ...
    database_management_config: Optional[dict] = Field(None, description="")
    database_version: Optional[str] = Field(
        None, description="The Oracle Database version."
    )
    ...
    db_packs: Optional[str] = Field(
        None,
        description="The database packs licensed for the external Oracle Database.",
    )
    db_unique_name: Optional[str] = Field(
        None, description="The `DB_UNIQUE_NAME` of the external database."
    )
    defined_tags: Optional[str] = Field(
        None,
        description="Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see `Resource Tags`__. __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm",
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this ExternalContainerDatabaseSummary. The `OCID`__ of the Oracle Cloud Infrastructure external database resource. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    lifecycle_details: Optional[str] = Field(
        None, description="Additional information about the current lifecycle state."
    )
    ...
    ncharacter_set: Optional[str] = Field(
        None, description="The national character of the external database."
    )
    stack_monitoring_config: Optional[dict] = Field(None, description="")
    time_created: Optional[datetime] = Field(
        None,
...
class ExternalDatabaseConnectorSummary(OCIBaseModel):
    ...
    compartment_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the compartment_id of this ExternalDatabaseConnectorSummary. The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    ...
    external_database_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the external_database_id of this ExternalDatabaseConnectorSummary. The `OCID`__ of the external database resource. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    freeform_tags: Optional[str] = Field(
        None,
        description='Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see `Resource Tags`__. Example: `{"Department": "Finance"}` __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm',
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this ExternalDatabaseConnectorSummary. The `OCID`__ of the :func:`create_external_database_connector_details`. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    lifecycle_details: Optional[str] = Field(
        None, description="Additional information about the current lifecycle state."
    )
    ...
    time_connection_status_last_updated: Optional[datetime] = Field(
        None,
...
class ExternalNonContainerDatabaseSummary(OCIBaseModel):
    ...
    compartment_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the compartment_id of this ExternalNonContainerDatabaseSummary. The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    database_configuration: Optional[str] = Field(
        None,
        description="The Oracle Database configuration Allowed values for this property are: \"RAC\", \"SINGLE_INSTANCE\", 'UNKNOWN_ENUM_VALUE'. Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.",
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this ExternalNonContainerDatabaseSummary. The `OCID`__ of the Oracle Cloud Infrastructure external database resource. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    lifecycle_details: Optional[str] = Field(
        None, description="Additional information about the current lifecycle state."
    )
    ...
    operations_insights_config: Optional[dict] = Field(None, description="")
    stack_monitoring_config: Optional[dict] = Field(None, description="")
    time_created: Optional[datetime] = Field(
        None,
...
class ExternalPluggableDatabaseSummary(OCIBaseModel):
    ...
    compartment_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the compartment_id of this ExternalPluggableDatabaseSummary. The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    database_configuration: Optional[str] = Field(
        None,
        description="The Oracle Database configuration Allowed values for this property are: \"RAC\", \"SINGLE_INSTANCE\", 'UNKNOWN_ENUM_VALUE'. Any unrecognized values returned by a service will be mapped to 'UNKNOWN_ENUM_VALUE'.",
    ...
    external_container_database_id: Optional[str] = Field(
        None,
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this ExternalPluggableDatabaseSummary. The `OCID`__ of the Oracle Cloud Infrastructure external database resource. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    lifecycle_details: Optional[str] = Field(
        None, description="Additional information about the current lifecycle state."
    )
    ...
    source_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the the non-container database that was converted to a pluggable database to create this resource. __ https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm",
    )
    stack_monitoring_config: Optional[dict] = Field(None, description="")
    time_created: Optional[datetime] = Field(
        None,
...
class GiMinorVersionSummary(OCIBaseModel):
    ...
    grid_image_id: Optional[str] = Field(
        None, description="Grid Infrastructure Image Id"
    )
    version: Optional[str] = Field(
        None,
...
class KeyStoreSummary(OCIBaseModel):
    ...
    associated_databases: Optional[list[dict]] = Field(
        None, description="List of databases associated with the key store."
    )
    compartment_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the compartment_id of this KeyStoreSummary. The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    defined_tags: Optional[str] = Field(
        None,
        description="Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see `Resource Tags`__. __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm",
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this KeyStoreSummary. The `OCID`__ of the key store. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    lifecycle_details: Optional[str] = Field(
        None, description="Additional information about the current lifecycle state."
    )
    ...
    time_created: Optional[datetime] = Field(
        None, description="The date and time that the key store was created."
    )
    type_details: Optional[dict] = Field(
        None,
...
class MaintenanceRunHistorySummary(OCIBaseModel):
    ...
    current_execution_window: Optional[str] = Field(
        None, description="The OCID of the current execution window."
    )
    db_servers_history_details: Optional[list[dict]] = Field(
        None, description="List of database server history details."
    )
    granular_maintenance_history: Optional[int] = Field(
        None, description="The list of granular maintenance history details."
    )
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this MaintenanceRunHistorySummary. The OCID of the maintenance run history.",
    )
    maintenance_run_details: Optional[int] = Field(None, description="")
...
class MaintenanceRunSummary(OCIBaseModel):
    ...
    current_custom_action_timeout_in_mins: Optional[int] = Field(
        None,
    ...
    current_patching_component: Optional[str] = Field(
        None,
        description="The name of the current infrastruture component that is getting patched.",
    )
    custom_action_timeout_in_mins: Optional[int] = Field(
        None,
    ...
    database_software_image_id: Optional[str] = Field(
        None,
        description="The Autonomous Database Software Image `OCID`__ __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    description: Optional[str] = Field(
        None, description="Description of the maintenance run."
    )
    display_name: Optional[str] = Field(
        None,
        description="**[Required]** Gets the display_name of this MaintenanceRunSummary. The user-friendly name for the maintenance run.",
    )
    estimated_component_patching_start_time: Optional[datetime] = Field(
        None,
        description="The estimated start time of the next infrastruture component patching operation.",
    )
    estimated_patching_time: Optional[str] = Field(None, description="")
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this MaintenanceRunSummary. The OCID of the maintenance run.",
    )
    is_custom_action_timeout_enabled: Optional[bool] = Field(
        None,
    ...
    is_maintenance_run_granular: Optional[bool] = Field(
        None,
    ...
    maintenance_subtype: Optional[str] = Field(
        None,
    ...
    patch_failure_count: Optional[int] = Field(
        None, description="Contain the patch failure count."
    )
    patch_id: Optional[str] = Field(
        None,
    ...
    patching_end_time: Optional[datetime] = Field(
        None, description="The time when the patching operation ended."
    )
    patching_mode: Optional[str] = Field(
        None,
    ...
    patching_start_time: Optional[datetime] = Field(
        None, description="The time when the patching operation started."
    )
    patching_status: Optional[str] = Field(
        None,
    ...
    peer_maintenance_run_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the maintenance run for the Autonomous Data Guard association's peer container database. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    target_db_server_version: Optional[str] = Field(
        None,
    ...
    target_storage_server_version: Optional[str] = Field(
        None, description="The target Cell version that is to be patched to."
    )
    time_ended: Optional[datetime] = Field(
        None, description="The date and time the maintenance run was completed."
    )
    time_scheduled: Optional[datetime] = Field(
        None,
    ...
    time_started: Optional[datetime] = Field(
        None, description="The date and time the maintenance run starts."
    )
    total_time_taken_in_mins: Optional[int] = Field(
        None,
        description="The total time taken by corresponding resource activity in minutes.",
...
class OneoffPatchSummary(OCIBaseModel):
    ...
    compartment_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the compartment_id of this OneoffPatchSummary. The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    db_version: Optional[str] = Field(
        None,
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this OneoffPatchSummary. The `OCID`__ of the one-off patch. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    lifecycle_details: Optional[str] = Field(
        None, description="Detailed message for the lifecycle state."
    )
    ...
    release_update: Optional[str] = Field(
        None,
    ...
    sha256_sum: Optional[str] = Field(
        None, description="SHA-256 checksum of the one-off patch."
    )
    size_in_kbs: Optional[float] = Field(
        None, description="The size of one-off patch in kilobytes."
    )
    time_created: Optional[datetime] = Field(
        None,
        description="**[Required]** Gets the time_created of this OneoffPatchSummary. The date and time one-off patch was created.",
    )
    time_of_expiration: Optional[datetime] = Field(
        None,
        description="The date and time until which the one-off patch will be available for download.",
    )
    time_updated: Optional[datetime] = Field(
        None, description="The date and time one-off patch was updated."
    )
...
class PluggableDatabaseSummary(OCIBaseModel):
    ...
    compartment_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the compartment_id of this PluggableDatabaseSummary. The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    connection_strings: Optional[str] = Field(None, description="")
    container_database_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the container_database_id of this PluggableDatabaseSummary. The `OCID`__ of the CDB. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    defined_tags: Optional[str] = Field(
        None,
        description="Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see `Resource Tags`__. __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm",
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this PluggableDatabaseSummary. The `OCID`__ of the pluggable database. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
...
class SchedulingPolicySummary(OCIBaseModel):
    ...
    cadence_start_month: Optional[str] = Field(
        None, description="Start of the month to be followed during the cadence period."
    )
    compartment_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the compartment_id of this SchedulingPolicySummary. The `OCID`__ of the compartment. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    defined_tags: Optional[str] = Field(
        None,
        description="Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see `Resource Tags`__. __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm",
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this SchedulingPolicySummary. The `OCID`__ of the Scheduling Policy. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    lifecycle_details: Optional[str] = Field(
        None, description="Additional information about the current lifecycle state."
    )
    ...
    time_created: Optional[datetime] = Field(
        None, description="The date and time the Scheduling Policy was created."
    )
    time_next_window_starts: Optional[datetime] = Field(
        None,
...
class SchedulingWindowSummary(OCIBaseModel):
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this SchedulingWindowSummary. The `OCID`__ of the Scheduling Window. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    lifecycle_details: Optional[str] = Field(
        None, description="Additional information about the current lifecycle state."
    )
    ...
    scheduling_policy_id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the scheduling_policy_id of this SchedulingWindowSummary. The `OCID`__ of the Scheduling Policy. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    time_created: Optional[datetime] = Field(
        None, description="The date and time the Scheduling Window was created."
    )
    time_next_scheduling_window_starts: Optional[datetime] = Field(
        None,
    ...
    window_preference: Optional[str] = Field(
        None,
...
class VmClusterNetworkSummary(OCIBaseModel):
    ...
    dr_scans: Optional[list[dict]] = Field(
        None, description="The SCAN details for DR network"
    )
    exadata_infrastructure_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the Exadata infrastructure. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    ...
    id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the VM cluster network. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    lifecycle_details: Optional[str] = Field(
        None, description="Additional information about the current lifecycle state."
    )
    ...
    ntp: Optional[str] = Field(
        None, description="The list of NTP server IP addresses. Maximum of 3 allowed."
    )
    scans: Optional[list[dict]] = Field(None, description="The SCAN details.")
    time_created: Optional[datetime] = Field(
        None, description="The date and time when the VM cluster network was created."
    )
    vm_cluster_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the associated VM Cluster. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    vm_networks: Optional[list[dict]] = Field(
        None, description="Details of the client and backup networks."
    )
...
class VmClusterUpdateSummary(OCIBaseModel):
    ...
    id: Optional[str] = Field(
        None,
        description="**[Required]** Gets the id of this VmClusterUpdateSummary. The `OCID`__ of the maintenance update. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    last_action: Optional[str] = Field(
        None,
...
class VmClusterSummary(OCIBaseModel):
    ...
    data_collection_options: Optional[dict] = Field(None, description="")
    data_storage_size_in_gbs: Optional[float] = Field(
        None, description="Size of the DATA disk group in GBs."
    )
    data_storage_size_in_tbs: Optional[float] = Field(
        None, description="Size, in terabytes, of the DATA disk group."
    )
    ...
    db_servers: Optional[str] = Field(None, description="The list of Db server.")
    defined_tags: Optional[str] = Field(
        None,
        description="Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see `Resource Tags`__. __ https://docs.cloud.oracle.com/Content/General/Concepts/resourcetags.htm",
    )
    ...
    exascale_db_storage_vault_id: Optional[str] = Field(
        None,
        description="The `OCID`__ of the Exadata Database Storage Vault. __ https://docs.cloud.oracle.com/Content/General/Concepts/identifiers.htm",
    )
    file_system_configuration_details: Optional[list[dict]] = Field(
        None, description="Details of the file system configuration of the VM cluster."
    )
    ...
    storage_management_type: Optional[str] = Field(
        None,
    ...
    time_created: Optional[datetime] = Field(
        None, description="The date and time that the VM cluster was created."
    )
    time_zone: Optional[str] = Field(
        None,
        description="The time zone of the Exadata infrastructure. For details, see `Exadata Infrastructure Time Zones`__. __ https://docs.cloud.oracle.com/Content/Database/References/timezones.htm",
...
class ResourcePoolShapeCollection(OCIBaseModel):
    ...
    items: Optional[list[dict]] = Field(
        None, description="List of Autonomous Database resource pools Shapes."
    )
