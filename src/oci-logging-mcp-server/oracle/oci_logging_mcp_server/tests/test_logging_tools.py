...
class TestServer:
    ...
    @patch("oracle.oci_logging_mcp_server.server.get_access_token", return_value=None)
    ...
    @patch("oracle.oci_logging_mcp_server.server.OCIProvider")
...
class TestGetClient:
    @patch("oracle.oci_logging_mcp_server.server.oci.logging.LoggingManagementClient")
    @patch("oracle.oci_logging_mcp_server.server._get_http_config_and_signer")
    def test_get_logging_client_http(self, mock_http_config_and_signer, mock_client):
    ...
    @patch("oracle.oci_logging_mcp_server.server.oci.loggingsearch.LogSearchClient")
    @patch("oracle.oci_logging_mcp_server.server._get_http_config_and_signer")
    def test_get_logging_search_client_http(self, mock_http_config_and_signer, mock_client):
        mock_http_config_and_signer.return_value = ({"region": "us-phoenix-1"}, "signer")
