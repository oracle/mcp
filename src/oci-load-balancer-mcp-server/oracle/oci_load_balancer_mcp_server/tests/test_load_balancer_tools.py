...
class TestGetClient:
    ...
    @patch("oracle.oci_load_balancer_mcp_server.server._get_http_config_and_signer")
    def test_get_load_balancer_client_http(self, mock_http_config_and_signer, mock_client):
...
class TestServer:
    @patch("oracle.oci_load_balancer_mcp_server.server.oci.auth.signers.TokenExchangeSigner", return_value="signer")
    @patch("oracle.oci_load_balancer_mcp_server.server.get_access_token")
    ...
    @patch("oracle.oci_load_balancer_mcp_server.server.get_access_token", return_value=None)
    ...
    @patch("oracle.oci_load_balancer_mcp_server.server.OCIProvider")
