...
class TestServer:
    @patch(
        "oracle.oci_compute_instance_agent_mcp_server.server.oci.auth.signers.TokenExchangeSigner",
        return_value="signer",
    )
    @patch("oracle.oci_compute_instance_agent_mcp_server.server.get_access_token")
    def test_http_signer_uses_region_without_loading_config(
        self, mock_get_access_token, mock_signer, monkeypatch
    ):
    ...
    @patch("oracle.oci_compute_instance_agent_mcp_server.server.get_access_token", return_value=None)
    ...
    @patch("oracle.oci_compute_instance_agent_mcp_server.server.OCIProvider")
...
class TestGetClient:
    @patch(
        "oracle.oci_compute_instance_agent_mcp_server.server.oci.compute_instance_agent.ComputeInstanceAgentClient"
    )
    @patch("oracle.oci_compute_instance_agent_mcp_server.server._get_http_config_and_signer")
    def test_get_compute_instance_agent_client_http(self, mock_http_config_and_signer, mock_client):
